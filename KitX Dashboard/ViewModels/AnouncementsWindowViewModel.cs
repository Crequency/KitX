...
namespace KitX_Dashboard.ViewModels
{
    internal class AnouncementsWindowViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        {
            get => Program.AppConfig.Windows.AnnouncementWindow.Window_Width;
            set => Program.AppConfig.Windows.AnnouncementWindow.Window_Width = value;
        }

        internal static double Window_Height
        {
            get => Program.AppConfig.Windows.AnnouncementWindow.Window_Height;
            set => Program.AppConfig.Windows.AnnouncementWindow.Window_Height = value;
        }
