...
/// <see cref="KitX.Core.Device.PluginConnection"/> without any network socket. The
/// <see cref="OnMessage"/> delegate is invoked directly by tests to feed message text through
/// the real <c>PluginConnection.OnMessage</c> parsing path.
/// </summary>
