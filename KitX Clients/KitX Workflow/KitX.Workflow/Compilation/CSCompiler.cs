...
/// <see cref="CFG2CSConverter"/> for Roslyn syntax generation,
...
internal class CSCompiler
{
        ...
        out IReadOnlyList<string> compileErrors)
    {
        ...
        return LoadOrCompile(hash, workflowId, () =>
        {
            ...
            return CFG2CSConverter.GenerateCompilationUnit(script, formattedScript, pubVarTypes, hash);
        ...
        out IReadOnlyList<string> compileErrors)
    {
        ...
        var hash = CFG2CSConverter.IsDebugMode ? $"debug_{baseHash}" : baseHash;
        return LoadOrCompile(hash, workflowId, () =>
        {
        ...
        out IReadOnlyList<string> compileErrors)
    {
        ...
        try
        {
            ...
            var typeName = $"KitX.Workflow.Compilation.Generated.CompiledScript_{hash}";
