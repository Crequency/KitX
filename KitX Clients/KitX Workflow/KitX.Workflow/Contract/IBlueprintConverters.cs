...
public interface IBlockScriptToBlueprintConverter
{
    ...
    /// <returns>Converted Blueprint</returns>
    KitX.Core.Contract.Workflow.Blueprint Convert(KitX.Workflow.Contract.Models.BlockScript script);
}
...
public interface IBlueprintToBlockScriptConverter
{
    ...
    KitX.Workflow.Contract.Models.BlockScript ConvertToBlockScript(KitX.Core.Contract.Workflow.Blueprint blueprint);
}
