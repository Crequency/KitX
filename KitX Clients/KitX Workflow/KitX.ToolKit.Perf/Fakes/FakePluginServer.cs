...
/// <summary>
/// A scripted <see cref="IPluginServer"/> that exposes an injected connection list, a
/// connection-id dictionary, and an externally-raisable <c>PluginMessageReceived</c> event
/// so a benchmark can drive the plugin-event routing path.
/// </summary>
