...
//
// Extracted from the Dashboard VM (P4-α) so that the run-by-id path can reuse the
// exact same override semantics as the in-editor Run/DebugRun. Because v6 codegen inlines
