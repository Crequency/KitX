...
// single-truth IR and fires IrChanged whenever either side (BS or BP) writes a
...
/// BS/BP edits flow back through <see cref="SyncService"/>, which replaces
...
public sealed class WorkflowSession
{
    ...
    /// <summary>
    /// Fired after a BS or BP edit was applied. Receives the WorkflowChangeSet
